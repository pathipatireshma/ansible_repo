...
PRIVATE_IP=$(aws ec2 describe-instance --filters "Name=tag:Name,Values=${Instance_name}" --query 'Reservations[*].Instances[*].PrivateIpAddress' --output text)
